...
// import  from "./components/ciphers/";
// import  from "./components/ciphers/";
// import  from "./components/ciphers/";
...
const App = () => {
  ...
  // };
    const items = [
    ['Porta Cipher', <PortaCipher/>],
    ['ROT5Cipher', <ROT5Cipher/>],
    ['ROT13 Cipher', <ROT13Cipher/>],
    ['ROT18 Cipher', <ROT18Cipher/>],
    ['ROT47 Cipher', <ROT47Cipher/>],
    ['PigPenCipher', <PigPenCipher/>],
    ['Octal Cipher', <OctalCipher/>],
    ['OmniBook Cipher', <OmniBookCipher/>],
    ['OneTimePad Cipher', <OneTimePadCipher/>],
    ['Permutation Cipher', <PermutationCipher/>],
    ['RailFence Cipher', <RailFenceCipher/>],
    // ['', </>],
    // ['', </>],
    // ['', </>],
    // ['', </>],
